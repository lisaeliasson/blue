...
int main(int argc, char ** argv) {
	...
	shared_ptr<CubeAsset> p = shared_ptr<CubeAsset> (new CubeAsset(0, 0, 0));
	assets.push_back(p);

	assets.push_back(shared_ptr<CubeAsset> (new CubeAsset(10, 0, 0)));
	assets.push_back(shared_ptr<CubeAsset> (new CubeAsset(12, 0, 0)));
